...
import { globalSearching } from "@/lib/actions/general.action";
...
const GlobalResult = () => {
  ...
  useEffect(() => {
    const fetching = async () => {
      setLoading(true);
      try {
        const data: any = await globalSearching({ query: global, type });
        console.log(data);
        ...
        {loading === true ? (
          ...
          <div className="flex flex-col gap-2">
            {result.length > 0 ? (
              ...
              <p className="text-dark400_light900 body-medium text-center ">
